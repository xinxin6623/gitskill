...
| 2026-05-26 | retro | [[retros/2026-05-26-git-self-host-retro|2026-05-26-git-self-host-retro.md]] | git-self-host 主题首跑：5 query 全有效返回；新建 domain；候选池有 GitLab 重型项目被合理 reject；piku/gitea/soft-serve/goproxy.cn/athens 5 entries 入库 |
| 2026-05-26 | retro | [[retros/2026-05-26-claude-skills-collections-retro|2026-05-26-claude-skills-collections-retro.md]] | mattpocock/skills 等 6 entries 增补 claude-skills；mixed 模式分流 OK；README noise filter 漏过 `<source>/<picture>/<p align>` 需扩展 |
| 2026-05-25 | retro | [[retros/2026-05-25-5-domain-parallel-batch-retro|2026-05-25-5-domain-parallel-batch-retro.md]] | 5 agent 并行扫 local-llm-runtime / rag-engine / knowledge-graph / mcp-servers / screen-vision-assistant 共 25 entry 入库；首轮暴露 gh 未登录时 agent 行为不一致（2 个走匿名 REST、3 个严守 SKILL 停了）；总 73→98 |
...
| 2026-05-24 | retro | [[retros/2026-05-24-personality-test-retro|2026-05-24-personality-test-retro.md]] | MBTI 主题首跑：5 query 并发因 `archivedAt` 字段名 bug 全失败需串行重跑；README 返空率偏高；INDEX 自检 0 缺 0 孤儿 |
| 2026-05-23 | 优化清单 | [[retros/2026-05-23-skill-optimization-checklist|2026-05-23-skill-optimization-checklist.md]] | 综合 05-22 + 05-23 两份复盘 + radar 蓝本对照，输出 17 项可勾选优化清单（P0×6 / P1×6 / P2×5） |
| 2026-05-23 | retro | [[retros/2026-05-23-xiaozhi-ai-retro|2026-05-23-xiaozhi-ai-retro.md]] | xiaozhi 专名主题：5 个初始 query 只 1 个有结果，暴露 brand vs need 输入未分流问题；候选池一半是周边集成 |
| 2026-05-22 | retro | [[retros/2026-05-22-voice-avatar-multi-theme-retro|2026-05-22-voice-avatar-multi-theme-retro.md]] | 单会话连跑三轮（voice pipeline / AI 对话机器人 / 5 主题批量）35 个项目入库；首次记录 `--sort best-match` 报错等 8 个坑 |
