...
| ⭐ | 项目 | 用一句话 | 内存占用 |
|---|---|---|---|
| ⭐ | [[git-self-host/entries/piku__piku|piku/piku]] | `git push` 一键部署网站，最小 PaaS | 极低 |
| ⭐ | [[git-self-host/entries/go-gitea__gitea|go-gitea/gitea]] | 自托管 Git 平台事实标准，带 mirror | 中（200MB+） |
| | [[git-self-host/entries/charmbracelet__soft-serve|charmbracelet/soft-serve]] | 单二进制 SSH-only Git server | 极低 |
| ⭐ | [[git-self-host/entries/goproxy__goproxy.cn|goproxy/goproxy.cn]] | 国内 Go 依赖代理（公共服务） | N/A |
| | [[git-self-host/entries/gomods__athens|gomods/athens]] | 企业级自建 Go module 代理 | 中 |
