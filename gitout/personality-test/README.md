...
| ⭐ | repo | 一句话 | 场景 |
|---|---|---|---|
| ⭐ | [liyupi/yudada](./entries/liyupi__yudada.md) | 鱼皮 AI 答题平台教学项目（MBTI 是第一阶段，扩展性最强） | 想做通用答题平台 |
|   | [zcw576020095/mbti-test](./entries/zcw576020095__mbti-test.md) | Django MBTI 系统 + PDF 导出，最快可上线 | Python 用户挂站 |
|   | [MskTmi/MBTI](./entries/MskTmi__MBTI.md) | 纯静态 93 题中文版，5 分钟挂 Pages | 零部署体验 |
|   | [SwapnilSoni1999/16personalities-api](./entries/SwapnilSoni1999__16personalities-api.md) | 16personalities.com 非官方 API，只写前端 | 题库即用 |
|   | [lilemy/mbti-mini](./entries/lilemy__mbti-mini.md) | TypeScript 微信小程序参考实现 | 小程序起点 |
